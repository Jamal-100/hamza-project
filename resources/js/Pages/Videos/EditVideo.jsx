// resources/js/Pages/Videos/EditVideo.jsx
...
export default function EditVideo() {
    const { video, units } = usePage().props;
    const [videoPreview, setVideoPreview] = useState(video.url || null);
    ...
    const { data, setData, post, processing, errors, progress } = useForm({
        ...
        _method: 'PUT'  // استخدام طريقة PUT للتحديث
    });
        ...
        <div className="container mx-auto px-4" dir="rtl">
            <div className="py-6">
                <div className="flex justify-between items-center mb-6">
                    <h1 className="text-2xl font-semibold text-gray-800">تعديل الفيديو</h1>
                    <Link
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4">
                            ...
                            />
                            <p className="text-sm text-gray-500 mt-1">اترك هذا الحقل فارغًا إذا كنت لا ترغب في تغيير ملف الفيديو</p>
                        ...
                        <div className="flex justify-end">
                            ...
                            >
                                {processing ? 'جاري التحديث...' : 'تحديث الفيديو'}
                            </button>
                        </div>
                    </form>
                </div>
...
EditVideo.layout = page => <DashboardLayout children={page} />;